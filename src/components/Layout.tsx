...
import { Menu, X, Lock, ArrowRight, Linkedin, Mail } from 'lucide-react';
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-16">
            <div className="lg:col-span-2">
              <span className="font-serif text-3xl font-bold text-white mb-6 block">AstraESG</span>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm">
                <li><Link to="/services" className="hover:text-white transition-colors">BRSR Reporting</Link></li>
                <li><Link to="/services" className="hover:text-white transition-colors">Net Zero Strategy</Link></li>
                <li><Link to="/services" className="hover:text-white transition-colors">Carbon Accounting</Link></li>
                <li><Link to="/services" className="hover:text-white transition-colors">ESG Due Diligence</Link></li>
                <li><Link to="/services" className="hover:text-white transition-colors">CSR Advisory</Link></li>
              </ul>
            </div>
          ...
          <div className="pt-8 border-t border-slate-800 text-xs flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-slate-500">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-6">
              <p>&copy; {new Date().getFullYear()} AstraESG Consulting Pvt. Ltd. All rights reserved.</p>
