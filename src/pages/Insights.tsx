...
export default function Insights() {
  ...
  const insights = [
    ...
    { tag: "Webinar", title: "Preparing for the EU Carbon Border Adjustment Mechanism", date: "February 01, 2026", img: "https://picsum.photos/seed/webinar/600/400", link: "/insights" }
  ];
      ...
      <section className="py-24">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {insights.map((post, i) => (
              <motion.div key={i} {...fadeIn} transition={{ delay: i * 0.1 }} className="group flex flex-col">
                <Link to={post.link} className="flex flex-col h-full">
